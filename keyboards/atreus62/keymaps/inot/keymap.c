...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_DEFAULT] = LAYOUT( /* qwerty */
    QK_GRAVE_ESCAPE, KC_1,    KC_2,    KC_3,    KC_4,        KC_5,                        KC_6,    KC_7,    KC_8,    KC_9,    KC_0,     KC_BACKSPACE ,
  ...
  [_RAISE] = LAYOUT(
    ...
    KC_TRNS,  KC_EQUAL,   KC_MINUS,   LSFT(KC_EQUAL),   LSFT(KC_LBRC), LSFT(KC_RBRC),                     KC_LBRC, KC_RBRC, KC_SCLN,  LSFT(KC_SCLN), KC_BSLS,  KC_TRNS,
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_TRNS, KC_INSERT,  KC_PSCR, KC_APPLICATION, KC_NO,      KC_NO,                         KC_PGUP,   KC_TRNS, KC_UP,   KC_TRNS,  KC_TRNS,    KC_BACKSPACE,
    KC_TRNS, KC_LALT,    KC_LCTL,   KC_LSFT,      KC_NO,      KC_CAPS,                       KC_PGDN, KC_LEFT, KC_DOWN, KC_RIGHT, KC_DELETE,  KC_BACKSPACE,
